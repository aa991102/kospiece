        ...
        <ul class="list">
            ...
            <li class="list-item">
                ...
                <ul class="sub-list-my">
                    <li class="sub-item-my"><a href="<%= request.getContextPath()%>/mypage/myFavorite.jsp">관심주식</a></li>
                    <li class="sub-item-my"><a href="<%= request.getContextPath()%>/mypage/myPost.jsp">내 게시글</a></li>
                    <li class="sub-item-my"><a href="<%= request.getContextPath()%>/mypage/myInfo.jsp">내 정보</a></li>
                </ul>
            </li>
        </ul>
