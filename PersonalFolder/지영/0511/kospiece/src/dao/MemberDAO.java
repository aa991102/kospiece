...
public class MemberDAO {
	...
	public void update(Connection conn,MemberVO member) throws SQLException{
		try(PreparedStatement pstmt = conn.prepareStatement("update member set password=? where mid=?")){
